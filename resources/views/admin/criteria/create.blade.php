...
@section('title', 'Create New Criteria')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Criteria</h3>
                    ...
                    <form action="{{ route('admin.criteria.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('min_age') is-invalid @enderror" 
                                       id="min_age" name="min_age" value="{{ old('min_age') }}" min="0">
                                @error('min_age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('max_age') is-invalid @enderror" 
                                       id="max_age" name="max_age" value="{{ old('max_age') }}" min="0">
                                @error('max_age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('married') is-invalid @enderror" id="married" name="married">
                                    <option value="">Any</option>
                                    <option value="yes" {{ old('married') == 'yes' ? 'selected' : '' }}>Yes</option>
                                </select>
                                @error('married')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('vocation') is-invalid @enderror" id="vocation" name="vocation">
                                    <option value="">Any</option>
                                    <option value="priest_only" {{ old('vocation') == 'priest_only' ? 'selected' : '' }}>Priest Only</option>
                                    <option value="sisters_only" {{ old('vocation') == 'sisters_only' ? 'selected' : '' }}>Sisters Only</option>
                                </select>
                                @error('vocation')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Create Criteria
                            </button>
                        </div>
                    </form>
                </div>
