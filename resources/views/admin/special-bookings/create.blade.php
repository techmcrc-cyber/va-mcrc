                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control participant-whatsapp" name="participants[${participantCount}][whatsapp_number]" value="${participantData ? participantData.whatsapp_number || '' : ''}" maxlength="15" pattern="[0-9]{7,15}" required>
                                </div>
                                <small class="form-text text-muted">Enter phone number without country code</small>
                            </div>
                        </div>
