...
@section('title', 'Active Retreat Bookings')
...
<div class="container-fluid">
    <div class="card mb-2">
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #f8f9fc; border-bottom: 1px solid #e3e6f0;">
            <h4 class="m-0 fw-bold" style="color: #b53d5e; font-size: 1.5rem;">Active Retreat Bookings</h4>
...
$(document).ready(function() {
    var table = $('#bookings-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.bookings.active') }}",
            type: "GET",
            data: function(d) {
