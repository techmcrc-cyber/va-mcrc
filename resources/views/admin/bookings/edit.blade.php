                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="country_code" id="country_code" class="form-select" style="max-width: 180px;" required>
                                            {!! render_country_code_options(old('country_code', $booking->country_code)) !!}
                                        </select>
                                        <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" value="{{ old('whatsapp_number', $booking->whatsapp_number) }}" maxlength="15" pattern="[0-9]{7,15}" required>
                                    </div>
