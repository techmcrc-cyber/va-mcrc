...
@section('title', 'Edit Special Booking: ' . $specialBooking->booking_id)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Special Booking: {{ $specialBooking->booking_id }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.special-bookings.show', $specialBooking->id) }}" class="btn btn-sm btn-info">
                ...
                <!-- /.card-header -->
                <form action="{{ route('admin.special-bookings.update', $specialBooking->id) }}" method="POST" id="booking-form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="special_remarks" id="special_remarks" class="form-control" rows="2" placeholder="Any special instructions or remarks">{{ old('special_remarks', $specialBooking->special_remarks) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="firstname" name="firstname" value="{{ old('firstname', $specialBooking->firstname) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lastname" name="lastname" value="{{ old('lastname', $specialBooking->lastname) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="gender" name="gender" required>
                                        ...
                                        <option value="male" {{ old('gender', $specialBooking->gender) == 'male' ? 'selected' : '' }}>Male</option>
                                        <option value="female" {{ old('gender', $specialBooking->gender) == 'female' ? 'selected' : '' }}>Female</option>
                                        <option value="other" {{ old('gender', $specialBooking->gender) == 'other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="married" name="married">
                                        ...
                                        <option value="yes" {{ old('married', $specialBooking->married) == 'yes' ? 'selected' : '' }}>Married</option>
                                        <option value="no" {{ old('married', $specialBooking->married) == 'no' ? 'selected' : '' }}>Unmarried</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $specialBooking->email) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $specialBooking->address) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $specialBooking->city) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $specialBooking->state) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="diocese" name="diocese" value="{{ old('diocese', $specialBooking->diocese) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="parish" name="parish" value="{{ old('parish', $specialBooking->parish) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('congregation') is-invalid @enderror" id="congregation" name="congregation" value="{{ old('congregation', $specialBooking->congregation) }}">
                                    @error('congregation')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="emergency_contact_name" name="emergency_contact_name" value="{{ old('emergency_contact_name', $specialBooking->emergency_contact_name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="emergency_contact_phone" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $specialBooking->emergency_contact_phone) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="participants-container">
                                    ...
                                    @foreach($allParticipants as $participant)
                                        @if($participant->id !== $specialBooking->id)
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Special Booking
                        </button>
                        <a href="{{ route('admin.special-bookings.show', $specialBooking->id) }}" class="btn btn-default">
